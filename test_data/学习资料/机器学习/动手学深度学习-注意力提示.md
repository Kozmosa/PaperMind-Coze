> 来源：《动手学深度学习》注意机制章节之"注意力提示"，Aston Zhang、Mu Li、Zachary Lipton 等
> 原文：https://github.com/d2l-ai/d2l-zh （文本部分采用 CC BY-NC-SA 许可，代码 MIT，内部演示/测试用途摘录）
> 摘录说明：原样收录该小节，为便于离线演示移除了图片引用与交叉链接标记。
...
【插图：由于突出性的非自主性提示（红杯子），注意力不自主地指向了咖啡杯】（原文含示意图，演示版略）
:width:`400px`
...
【插图：依赖于任务的意志提示（想读一本书），注意力被自主引导到书上】（原文含示意图，演示版略）
:width:`400px`
...
【插图：注意力机制通过注意力汇聚将*查询*（自主性提示）和*键*（非自主性提示）结合在一起，实现对*值*（感官输入）的选择倾向】（原文含示意图，演示版略）
