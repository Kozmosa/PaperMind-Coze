    ...
    <Screen statusBarStyle="dark" safeAreaEdges={['left', 'right', 'bottom']}>
      <View className="flex-1">
        ...
        >
          ...
          <Text style={{ fontSize: 22, fontWeight: '800', color: '#2D3436', marginTop: 12 }}>
            我的学习
          </Text>
        </View>
              ...
              {reflections.slice(0, 3).map((ref) => (
                <TouchableOpacity
                  ...
                  style={{
                    paddingVertical: 12,
                    borderBottomWidth:
                      ref.id !== reflections.slice(0, 3)[reflections.slice(0, 3).length - 1]?.id
                        ? 1
                        : 0,
                ...
                >
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text
                      style={{ fontSize: 14, fontWeight: '600', color: '#2D3436', marginLeft: 8 }}
                    >
